...
def main():
    ...
    N_total = 20_000
    learn_size = 5_000
    #checkpoint_dir = train_and_save(env, N_total=N_total, learn_size=learn_size,training_lineup=SELF_PLAY_LINEUP, checkpoint_root="checkpoints")
    checkpoint_dirs = {
    ...
    eval_checkpoint_dir(checkpoint_dirs=checkpoint_dirs,
                            n_workers_per_lineup=4, n_tournaments_per_worker=1_000)
